...
import { type ItemInfo, type OrderInfo, type OrderInfoForShopAndrider, type OrderList } from '@/types/order'

export async function fetchOrders(page: number, pageSize: number, s: string) {
